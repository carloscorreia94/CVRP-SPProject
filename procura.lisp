...
;; if we have final-state, just compare. otherwise, we need objective function!!
(defun cria-problema (estado-inicial operadores 
  ...
  (let ((obj? (cond 
    ;; obj is either objectivo as a function, 
    ((functionp objectivo?) objectivo?)
		;; if we have optional final state bounded
    (estado-final
		     #'(lambda (estado) 
